...
static void late_resume(struct work_struct *work)
{
	...
	printk(KERN_INFO "Ant: resume set GPAA7 to 0\n") ;
	// wake up touch panel -- will remove until touch driver is ready
	//gpio_free(14) ;
	//gpio_request(14, "Touch Wakeup GPIO") ;
