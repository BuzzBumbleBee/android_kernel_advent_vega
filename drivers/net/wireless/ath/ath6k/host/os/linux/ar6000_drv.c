...
char *fm_path = NULL;
char *tgt_fw = "/lib/firmware/athwlan.bin.z77";
char *tgt_patch = "/lib/firmware/data.patch.hw2_0.bin";
char *tcmd_fw = "/lib/firmware/athtcmd_ram.bin";
char *art_fw = "/lib/firmware/device.bin";
char *eeprom_bin = "/lib/firmware/eeprom.bin";
char *eeprom_data = "/lib/firmware/eeprom.data";


#ifdef REGION_CODE_FILE_USED
char *reg_file = "/lib/firmware/reg_code";
#else
char *reg_file = NULL;
#endif

#ifdef SOFTMAC_USED
char *softmac_file = "/lib/firmware/softmac";
#else
char *softmac_file = NULL;
#endif

#ifdef EEPROM_FILE_USED
char *eeprom_file = "/lib/firmware/calData_ar6102_15dBm.bin";
/*char *eeprom_file = "/lib/firmware/fakeBoardData_AR6002.bin"; */
#else
...
/* ATHENV */
    ...
    {   /*
         ...
         */
        char *argv[] = { "/lib/firmware/athfwloader", NULL };
